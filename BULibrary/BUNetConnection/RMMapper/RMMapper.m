...
+ (NSDictionary *)propertiesForClass:(Class)cls
{
    ...
    {
        Class super_class = tempClass;
        
      
        
        unsigned int outCount, i;
        objc_property_t *properties = class_copyPropertyList(super_class, &outCount);
...
//                id childObj = [[NSMutableDictionary alloc] init];
...
//                
        ...
        if ([propertyType isEqualToString:@"NSString"] \
            ...
            if ([propertyType isEqualToString:@"NSString"] == NO &&
                ...
                [propertyType isEqualToString:@"id"] == NO &&
