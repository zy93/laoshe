...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    m_pTitleLable.font = [UIFont fontWithName:[AppConfigure RegularFont] size:15];
...
-(void)SetData:(NSArray*)arrData andImageUrls:(NSArray*)argImageUrls andTitle:(NSArray *)argTitle
{
    ...
    for(NSInteger i=0; i<iCount+1; i++)
    {
        ...
        YYBannerData *pData = m_arrData[iIndex];
        NSString* strUrl = pData.cover;
        ...
        [pImageView setImageWithURL:pURL placeholderImage:[UIImage imageNamed:@"banner_place_holder"]];
