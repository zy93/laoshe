...
-(void)CreateSubViews
{
    ...
    //第一行头缩进
    [paragraphStyle setFirstLineHeadIndent:28.0];
    ...
    [m_pIntroduceLab1 setAttributedText:attributedString];
...
+(CGFloat)GetHeight
{
    ...
    return 310*[AppConfigure GetLengthAdaptRate]+fContentH1+fContentH2+fContentH3+((17*[AppConfigure GetLengthAdaptRate])*3) + 63*[AppConfigure GetLengthAdaptRate];
}
