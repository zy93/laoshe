...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        m_pBackgroundView.autoresizingMask = UIViewAutoresizingFlexibleWidth;
        m_pBackgroundView.backgroundColor = [UIColor clearColor];
        ...
        m_pScrollView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.0f];
...
- (void)ResetAllImageView:(UIImageView *)imageView
{
    ...
    for (NSInteger i = 0; i < m_arrImageView.count; i ++)
    {
        ...
        AFZoomView *pZoomView = [[AFZoomView alloc]initWithFrame:CGRectMake(i * kItemWidth, 0, 0, 0) UrlLoad:m_bIsUrlLoad];
