...
-(CGSize) SizeThatAdaptImageInSize:(CGSize)argSize
{
    ...
    CGFloat fNewWidth = 0;
    CGFloat fNewHeight = 0;
    if(fWidth/fHeight >= argSize.width/argSize.height )
    {
        fNewWidth = argSize.width;
        fNewHeight = fNewWidth*fHeight/fWidth;
    }
    else if(fWidth/fHeight < argSize.width/argSize.height)
    {
        fNewHeight = argSize.height;
        fNewWidth = fNewHeight*fWidth/fHeight;
    }
    return CGSizeMake(fNewWidth, fNewHeight);
}
